...
import CaseCitizensTable from "../criminal_cases/CaseCitizensTable";
...
const CaseView = () => {
	...
	useEffect(() => {
		...
		if (case_id) {
			dispatch(civilCaseCitizens(Number(case_id)));
			setCaseDetails(
				civilCaseList.find((case_: any) => case_.id === Number(case_id))
			);
		...
		<div className="flex flex-col gap-y-5 font-mont text-gray-700">
			...
			<div className="w-full grid grid-cols-2 gap-x-5 items-start">
				...
				<div className="bg-white p-5 shadow border-b border-gray-200 rounded-lg flex flex-col gap-y-5">
					...
					{!dataLoading && (
						<CaseCitizensTable
							caseCitizensList={civilCaseCitizensList}
