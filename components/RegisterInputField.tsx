...
const RegisterInputField = ({ control, fieldLabel, fieldType, fieldName, fieldRules, defaultValue, placeHolder }: MyInputFieldProps) => {
    return (
        <Controller 
            control={ control }
            name={ fieldName }
            ...
            render={({
                ...
                <div className="flex flex-col gap-y-1">
                    ...
                    <input 
                        type={ fieldType }
                        id={ fieldName }
                        className="bg-gray-700 px-4 py-2 w-[456px] focus:outline-none border-2 border-gray-700 focus:border-cyan-700 rounded-lg" 
